...
| Áudio | ✅ | **Validado ao vivo em 2026-09-04:** Qualcomm Hexagon ADSP + SPMI WCD analog codec funcional, placa ALSA `motorolapotter` (`plughw:0,0`). Reprodução de áudio MP3 audível no alto-falante físico via GStreamer/ALSA. |
