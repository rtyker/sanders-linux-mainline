...
| Wi-Fi (QCA WCN3680B / pronto) | ⚠️ | Hardware OK (scan funciona). Auth+assoc completam. Fallback V0 para `hal_config_bss/sta` preparado em `kernel/0002-wcn36xx-wcn3680-novht-fallback.patch`; resultado WPA2 ainda pendente de teste no aparelho. Veja secao "Wi-Fi WCN3680B" abaixo. |
